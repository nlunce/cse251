...
class Factory(threading.Thread):
    ...
    def __init__(self, queue, new_car, empty_slots, log):
...
class Dealer(threading.Thread):
    ...
    def __init__(self, queue, new_car, empty_slots, queue_stats, log):
...
def main():
    ...
    factory = Factory(queue, new_car, empty_slots, log)

    # FACTORY  AND DEALER NEAD SEMAPHORS TO KEEP IN SYNC
    # DONE create your one dealership
    dealer = Dealer(queue, new_car, empty_slots, queue_stats, log)
